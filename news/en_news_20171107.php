<div id="<?php echo basename(__FILE__,'.php');?>" class="newsheader">
	Welcome to the New Committer Jose Cabral
</div>
<div class="news">
	<span class="left"><?php $date="2017-11-07 17:25"; echo $date;?></span> 
	<span class="right">Age: <?php echo date_diff(date_create(date("Y-m-d h:i", strtotime($date))),date_create(date("Y-m-d h:i")))->format("%a days");?></span>
</div>

<p>We would like to warmly welcome Jose Cabral to the committers' Team. 
Over the last two years Jose has been increasingly contributing to 4diac. 
