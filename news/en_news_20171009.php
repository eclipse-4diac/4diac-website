...
<p>In 2006 a handful researchers had a crazy idea: to provide a full-fledged open source 
IEC 61499 PLC environment, based on the results of two public funded research projects. The idea of 4diac was born. 
...
in Vienna. Now ten years later the idea does not look so crazy anymore. 
...
Also FORTE changed a lot: it got more than twice as fast, uses only a third of its initial flash size and what is maybe the most important point 4diac now runs on several PLCs 
...
<ul>
	...
	<li><i>"4diac has allowed NOJA Power to lead the market with an innovative Smart Grid Automation solution for our Electricity Utility customers"</i>, Neil O'Sullivan, <a href="http://www.nojapower.com.au/">NOJA Power</a>
	</li>
